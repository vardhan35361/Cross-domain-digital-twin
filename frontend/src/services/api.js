...
export const api = {
  ...
  twinHistory: (domain, minutes = 60) => axios.get(`${API}/twins/${domain}/history?minutes=${minutes}`).then(r => r.data),
  twinActions: (domain) => axios.get(`${API}/twins/${domain}/actions`).then(r => r.data),
  twinAction: (domain, action, params = {}) => axios.post(`${API}/twins/${domain}/action`, {action, params}).then(r => r.data),
  trafficHistory: (minutes = 60) => axios.get(`${API}/traffic/history?minutes=${minutes}`).then(r => r.data),
  trafficRoadClose: (road_id, closed = true) => axios.post(`${API}/traffic/action/road.close`, {road_id, closed}).then(r => r.data),
